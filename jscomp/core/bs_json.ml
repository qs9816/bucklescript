...
and __ocaml_lex_lex_json_rec buf lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 137 "core/bs_json.gen.mll"
          ( lex_json buf lexbuf)
# 309 "core/bs_json.ml"

  | 1 ->
# 138 "core/bs_json.gen.mll"
                   ( 
    update_loc lexbuf 0;
    lex_json buf  lexbuf
  )
# 317 "core/bs_json.ml"
  ...
  | 2 ->
# 142 "core/bs_json.gen.mll"
                ( comment buf lexbuf)
# 322 "core/bs_json.ml"

  | 3 ->
# 143 "core/bs_json.gen.mll"
         ( True)
# 327 "core/bs_json.ml"

  | 4 ->
# 144 "core/bs_json.gen.mll"
          (False)
# 332 "core/bs_json.ml"

  | 5 ->
# 145 "core/bs_json.gen.mll"
         (Null)
# 337 "core/bs_json.ml"

  | 6 ->
# 146 "core/bs_json.gen.mll"
       (Lbracket)
# 342 "core/bs_json.ml"

  | 7 ->
# 147 "core/bs_json.gen.mll"
       (Rbracket)
# 347 "core/bs_json.ml"

  | 8 ->
# 148 "core/bs_json.gen.mll"
       (Lbrace)
# 352 "core/bs_json.ml"

  | 9 ->
# 149 "core/bs_json.gen.mll"
       (Rbrace)
# 357 "core/bs_json.ml"

  | 10 ->
# 150 "core/bs_json.gen.mll"
       (Comma)
# 362 "core/bs_json.ml"

  | 11 ->
# 151 "core/bs_json.gen.mll"
        (Colon)
# 367 "core/bs_json.ml"

  | 12 ->
# 152 "core/bs_json.gen.mll"
                      (lex_json buf lexbuf)
# 372 "core/bs_json.ml"

  | 13 ->
# 154 "core/bs_json.gen.mll"
         ( Number (Lexing.lexeme lexbuf))
# 377 "core/bs_json.ml"

  | 14 ->
# 156 "core/bs_json.gen.mll"
      (
...
# 388 "core/bs_json.ml"
  ...
  | 15 ->
# 163 "core/bs_json.gen.mll"
       (Eof )
# 393 "core/bs_json.ml"

  | 16 ->
let
# 164 "core/bs_json.gen.mll"
       c
# 399 "core/bs_json.ml"
...
and __ocaml_lex_comment_rec buf lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 166 "core/bs_json.gen.mll"
              (lex_json buf lexbuf)
# 415 "core/bs_json.ml"

  | 1 ->
# 167 "core/bs_json.gen.mll"
     (comment buf lexbuf)
# 420 "core/bs_json.ml"

  | 2 ->
# 168 "core/bs_json.gen.mll"
...
and __ocaml_lex_scan_string_rec buf start lexbuf __ocaml_lex_state =
  match Lexing.engine __ocaml_lex_tables __ocaml_lex_state lexbuf with
      | 0 ->
# 172 "core/bs_json.gen.mll"
      ( () )
# 437 "core/bs_json.ml"

  | 1 ->
# 174 "core/bs_json.gen.mll"
  (
...
# 456 "core/bs_json.ml"
  ...
  | 3 ->
let
# 186 "core/bs_json.gen.mll"
                                               c
# 462 "core/bs_json.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 1) in
# 187 "core/bs_json.gen.mll"
      (
...
# 521 "core/bs_json.ml"
  ...
  | 6 ->
let
# 207 "core/bs_json.gen.mll"
             c
# 527 "core/bs_json.ml"
= Lexing.sub_lexeme_char lexbuf (lexbuf.Lexing.lex_start_pos + 1) in
# 208 "core/bs_json.gen.mll"
      (
        Buffer.add_char buf '\\';

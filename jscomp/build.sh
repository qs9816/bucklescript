...
make -j4 -r  core/bsppx_main.cmx core/bspack_main.cmx core/jsoo_main.cmx core/bspp_main.cmx core/js_generate_require.cmx core/js_pack.cmx core/js_cmi_datasets.cmx core/bs_dep_infos.cmx core/bs_dir.cmx  bin/bsc.exe  2>build.compile
make libs
